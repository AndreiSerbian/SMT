    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="container mx-auto">
        ...
        <section className="bg-white py-12 px-4 text-center rounded-xl">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-6">Подарочная упаковка оптом</p>
          <a
            href="#catalog"
            className="inline-block bg-blue-900 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition"
          >
        ...
        <section className="bg-white py-16 px-4" id="about-boxes">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">Что мы продаём</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <article className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow transition">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">На магнитах и лентах. Удобная конструкция — без клея.</p>
                  </div>
                </div>
              </article>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Сэкономят ваше время на подготовку к 8 Марта, Дню рождения, Новому году, 14 февраля и любому
                      другому событию.
                    </p>
                  </div>
                </div>
              ...
              <article className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow transition">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800">Широкий ассортимент</h3>
                    <p className="text-gray-600 mt-1">
              ...
              <article className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow transition">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Коробки на магнитах помогают быстро и красиво оформить подарки коллегам, родным, детям и
                      родителям.
                    </p>
                  </div>
                </div>
              ...
              <article className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow transition md:col-span-2 lg:col-span-1">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Элегантный дизайн впечатляет не только именинника, но и всех вокруг — подарок выглядит премиально
                      и запоминается.
                    </p>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Все коробки самосборные и поставляются в разобранном виде. Это экономит место при транспортировке и
                    хранении.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Коробка легко собирается и держится на магнитах и уголках. Бант украшает и скрепляет конструкцию.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    У нас большой выбор коробок: косметика, одежда, техника, сладости и многое другое. Формы и расцветки
                    на любой вкус.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Коробки из картона плотностью 1200 г/м². Толщина стенок — 2 мм. На ряде премиум коробок используется
                    anti-scratch пленка обеспечивая её прочность.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Тщательная упаковка каждого заказа. Мы заботимся, чтобы коробка дошла до вас в идеальном виде.
                  </p>
                </div>
              </div>
            </div>
