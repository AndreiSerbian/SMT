    ...
    container.innerHTML = `
      ...
      <div class="container mx-auto px-4 py-8">
        ...
        <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-75 hidden z-50 flex items-center justify-center">
          <div class="relative w-full h-full flex items-center justify-center max-w-full max-h-full">
            <button 
              class="close-modal-btn absolute top-4 right-4 text-white hover:text-gray-300 text-4xl font-bold z-10 cursor-pointer"
            >
              ×
            </button>
